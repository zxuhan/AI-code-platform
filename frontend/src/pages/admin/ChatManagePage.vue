  ...
  <div id="chatManagePage">
    ...
    <a-form layout="inline" :model="searchParams" @finish="doSearch">
      <a-form-item label="Message">
        <a-input v-model:value="searchParams.message" placeholder="Message body" />
      </a-form-item>
...
const deleteMessage = async (id: number | undefined) => {
  ...
  try {
    // NOTE: requires a backend endpoint to delete chat history.
    // For now we just show success; the actual delete call needs to be wired up.
