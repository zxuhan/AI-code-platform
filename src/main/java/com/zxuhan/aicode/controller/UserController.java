...
import com.zxuhan.aicode.model.dto.user.*;
...
public class UserController {
     ...
     * Register a user.
     *
     * @param userRegisterRequest registration request
     ...
     * @return desensitized login user info
     */
    @PostMapping("/login")
    ...
    /**
     * Paginated list of user VOs (admin only).
     *
