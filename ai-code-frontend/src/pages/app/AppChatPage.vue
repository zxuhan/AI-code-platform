      ...
      <div class="chat-section">
        ...
        <div class="input-container">
          <div class="input-wrapper">
            <a-tooltip v-if="!isOwner" title="Cannot chat under someone else's work~" placement="top">
              <a-textarea
                v-model:value="userInput"
                placeholder="Please describe the website you want to generate, the more detailed the better"
                :rows="4"
                :maxlength="1000"
      ...
      <div class="preview-section">
        ...
        <div class="preview-content">
          <div v-if="!previewUrl && !isGenerating" class="preview-placeholder">
            ...
            <p>The website will be displayed here after generation is complete</p>
          </div>
